...
class LineGraph {
    constructor(svg) {
        this.svg = svg;
        this.hoverLine = document.createElementNS("http://www.w3.org/2000/svg", "line");
        this.hoverCircle = document.createElementNS("http://www.w3.org/2000/svg", "circle");
        ...
        svg.addEventListener("mousemove", (e) => {
            ...
            this.hoverCircle.setAttribute("cy", `${getInterpolatedY(e.offsetX, points)}`)
        })
